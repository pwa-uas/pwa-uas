...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function getUserPreferences() {
        ...
        const defaultPreferences = {
            name: "Nurfadlan Afiatuddin",
            email: "nurfadlan.afiatuddin096@gmail.com",
        };
    ...
    function promptForNameAndEmail() {
        ...
        `,
            ...
            if (result && result.dismiss !== "cancel") {
                ...
                const finalName = name || "Nurfadlan Afiatuddin ";
                const finalEmail = email || "nurfadlan.afiatuddin096@gmail.com";
    ...
    if (
        preferences.name === "Nurfadlan Afiatuddin" &&
        preferences.email === "nurfadlan.afiatuddin096@gmail.com"
    ) {
